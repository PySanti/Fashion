...
def model_builder(hp):
    ...
    n_hidden_layers         = hp.Int('n_hidden_layers', min_value=1, max_value=7, step=1)
    ...
    for a in range(n_hidden_layers):
        ...
        net.add(layers.Dense(units=hp.Int(f'layer_units_{a}', min_value=24, max_value=504, step=24), activation='relu'))
